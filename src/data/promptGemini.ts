...
4. Output Format  
   - Wrap the configuration in a code block  
   - Predict the appropriate preset (Low, Mid, High, Very High) based on device capability  
   - Use Wuthering Waves config syntax and structure, such as:
