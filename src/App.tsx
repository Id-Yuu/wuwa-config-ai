      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center mb-8">
          ...
          <div class="flex gap-4 items-center justify-center mt-3">
            <a href="https://github.com/Id-Yuu/wuwa-config-ai" target="_blank" class="bg-gray-200 block border border-gray-300 hover:bg-gray-300 p-2 rounded" title="GitHub">
            ...
            <a href="https://www.paypal.com/paypalme/arleth98" target="_blank" class="bg-gray-200 block border border-gray-300 hover:bg-gray-300 p-2 rounded" title="Support via PayPal">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
